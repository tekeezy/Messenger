...
<script type="text/javascript">
  ...
  function passwordCheck() {
    if (document.join_form.password.value != document.join_form.pwcheck.value) {
  ...
  function registration() {
    ...
    } else if (document.join_form.password.value != document.join_form.pwcheck.value) {
...
<div class="login-page">
      <div class="container">
          <form class="form-login" name="join_form" action="/registration" method="POST" enctype="multipart/form-data">
          ...
          <input type="hidden" name="_csrf" value="${_csrf.token}">
             ...
             비밀번호 확인<input type="password" class="form-control" id="pwcheck" name="pwcheck" placeholder="Password" onkeyup="passwordCheck()" /><span id="pwcheckspan"></span>
                ...
                <br/>
                <input type="button" class="btn btn-theme btn-block" onclick="registration()" value="가입">
